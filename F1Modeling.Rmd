...
<ul>
  <li>The model doesn't not perform well With R-squared values at 0.25.</li>
...
<hr>
<ul>
  <li>This model also performed well relative to the first two. It also provides the least amount of error, so we chose this as the best model - regardless of Model 2 having a higher R-squared.
</ul>
```{r}
set.seed(1234)
