...
racesDataFrame = racesDataFrame %>% filter(racesDataFrame$year >= "2000")
...
for(i in 1:nrow(raceResultsDataFrame)){
  ...
  else if(raceResultsDataFrame[i,]$year <= "2008"){
    raceResultsDataFrame[i,]$era = "90 degrees V8"
  }
  else if(raceResultsDataFrame[i,]$year <= "2013"){
    raceResultsDataFrame[i,]$era = "90 degrees V8 + KERS"
  }
  else if(raceResultsDataFrame[i,]$year > "2013"){
...
```{r}
write.csv(raceResultsDataFrame, "C:/SMU MS Data Science/AppliedStatistics6372/Project1/F1ParametricModeling/ModelingData/F1Modeling.csv")
```
...
```{r}
write.csv(raceResultsDataFrame, "C:/SMU MS Data Science/AppliedStatistics6372/Project1/F1ParametricModeling/ModelingData/F1ModelingCustomCategoricalVariables.csv")
```
