...
Translate the years to the rules of the car configuration
```{r}
...
raceResultsDataFrame$era = as.factor(raceResultsDataFrame$era)
raceResultsDataFrame$era = droplevels(raceResultsDataFrame$era)
